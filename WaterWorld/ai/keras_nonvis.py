...
import numpy as np
from WaterWorld.game.implementations.ple.ple import PLE  # our environment
...
class Agent(ExampleAgent):
    ...
    def build_model(self):
        model = Sequential()
        model.add(Dense(
            input_shape=(16,), units=256, activation="relu"
        ))
        model.add(Dense(
...
if __name__ == "__main__":
    ...
    # training parameters
    num_epochs = 15
    num_steps_train = 1500  # steps per epoch of training
    num_steps_test = 300
    ...
    # for our agent.
    #game = WaterWorld(width=128, height=128, num_creeps=10)
